...
| ----------------------------------------------------------------------- | --------------------------------- | ----------------------------------------------------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------- |
| [Where I applied](https://whereiapplied.vercel.app/)                    | App for tracking job applications | Typescript (React, MUI)                                           | 7 days            | [Repo](https://github.com/Arshad-Siddiqui/whereiapplied)                                                                |
